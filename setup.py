...
setup(
    ...
    packages=['venv.Lib.site-packages.PIL', 'venv.Lib.site-packages.pip', 'venv.Lib.site-packages.pip._vendor',
              ...
              'venv.Lib.site-packages.pytz', 'venv.Lib.site-packages.django', 'venv.Lib.site-packages.django.db',
              ...
              'venv.Lib.site-packages.django.templatetags', 'venv.Lib.site-packages.setuptools',
              ...
              'venv.Lib.site-packages.pip-10.0.1-py3.7.egg.pip._internal.operations', 'works', 'pictures',
              'pictures.migrations'],
    url='',
    license='',
    author='kzmrt',
